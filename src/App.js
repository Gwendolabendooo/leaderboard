  ...
  const fetchPlayerData = async () => {
    try {
      ...
      for (let i = 0; i < newUsers.length; i++) {
        ...
        let avg = 0;
        const ranking = await axios.get('https://euw1.api.riotgames.com/tft/league/v1/entries/by-summoner/'+user.id+'?api_key=RGAPI-682d85a2-7e8e-414e-a340-1e9ec38a0806');
